...
export function SurveysPage() {
    ...
    useEffect(() => {
        async function fetchSurveys() {
            try {
                const res = await fetchWithAuth("/api/jamath/surveys/");
                if (res.ok) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Button asChild>
                    <Link to="/dashboard/surveys/builder">
                        ...
                        <Card key={survey.id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <CardContent>
                                ...
                                <div className="mt-4 flex justify-between text-sm">
                                    ...
                                    {/* <Link to={`/dashboard/surveys/${survey.id}/responses`} className="text-blue-600 hover:underline">
                                        View Responses
                                    </Link> */}
                                </div>
                            </CardContent>
